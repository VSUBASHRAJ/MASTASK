...
- Improve accessibility for both technical and non-technical users  
...
2. **Processing (NLP + LLM)**  
   - Input sent to AI model (Mistral API)  
...
4. **Storage & Management**  
   ...
   - Features include edit, delete, search, and filters  

5. **Output Display**  
   Structured tasks displayed in user interface  
...
- Search, filter, edit, and delete functionality  
...
2. Submit input  
3. View structured task output  
4. Manage tasks using available features  
